...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 09 2016 г., 15:25
...
--
-- База данных: `zapengclub`
--

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_assets`
--

CREATE TABLE IF NOT EXISTS `mylr5_assets` (
...
--
-- Дамп данных таблицы `mylr5_assets`
--

INSERT INTO `mylr5_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 1, 67, 68, 1, 'com_jumi', 'com_jumi', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_associations`
--

CREATE TABLE IF NOT EXISTS `mylr5_associations` (
...
--
-- Структура таблицы `mylr5_banners`
--

CREATE TABLE IF NOT EXISTS `mylr5_banners` (
...
--
-- Структура таблицы `mylr5_banner_clients`
--

CREATE TABLE IF NOT EXISTS `mylr5_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `mylr5_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `mylr5_banner_tracks` (
...
--
-- Структура таблицы `mylr5_categories`
--

CREATE TABLE IF NOT EXISTS `mylr5_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `mylr5_categories`
--

INSERT INTO `mylr5_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Структура таблицы `mylr5_contact_details`
--

CREATE TABLE IF NOT EXISTS `mylr5_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `mylr5_content`
--

CREATE TABLE IF NOT EXISTS `mylr5_content` (
...
--
-- Структура таблицы `mylr5_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `mylr5_content_frontpage` (
...
--
-- Структура таблицы `mylr5_content_rating`
--

CREATE TABLE IF NOT EXISTS `mylr5_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `mylr5_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `mylr5_core_log_searches` (
...
--
-- Структура таблицы `mylr5_extensions`
--

CREATE TABLE IF NOT EXISTS `mylr5_extensions` (
...
--
-- Дамп данных таблицы `mylr5_extensions`
--

INSERT INTO `mylr5_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(700, 'files_joomla', 'file', 'joomla', '', 0, 1, 1, 1, '{"legacy":false,"name":"files_joomla","type":"file","creationDate":"September 2014","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.27","description":"FILES_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'Corporate', 'template', 'corporate', '', 0, 1, 1, 0, '{"legacy":false,"name":"Corporate","type":"template","creationDate":"August, 2013","author":"JoomlaTemplates.me","copyright":"Copyright 2013 - JoomlaTemplates.me","authorEmail":"support@JoomlaTemplates.me","authorUrl":"http:\\/\\/JoomlaTemplates.me","version":"3.1","description":"\\n\\t<h1>Corporate<\\/h1>\\n\\t<img src=\\"..\\/templates\\/corporate\\/template_thumbnail.png\\" align=\\"left\\" style=\\"padding-right:10px;\\"\\/>\\n\\t<b>Joomla Template developed by <a target=\\"_blank\\" href=\\"http:\\/\\/JoomlaTemplates.me\\">JoomlaTemplates.me<\\/a>, released under the <a target=\\"_blank\\" href=\\"http:\\/\\/www.gnu.org\\/licenses\\/gpl.html\\">GNU\\/GPL<\\/a> license.<br \\/>\\n\\t<br \\/>Need help to set up your template? Check out the <a target=\\"_blank\\" href=\\"http:\\/\\/JoomlaTemplates.me\\/documentation\\/\\" target=\\"_blank\\">documentation<\\/a> page.\\n\\t<br \\/><br \\/>Download free joomla extensions from <a target=\\"_blank\\" href=\\"http:\\/\\/jextensions.com\\">jExtensions.com<\\/a>,\\n\\t<br \\/><br \\/>Copyright &copy; 2013 JoomlaTemplates.me - All Rights Reserved<\\/b>\\n\\t","group":""}', '{"scrolltop":"yes","logotype":"image","sitetitle":"Corporate","sitedesc":"","menuid":"0","animation":"fade","Caption1":"","Caption2":"","Caption3":"","Caption4":"","Caption5":"","Caption6":"","Caption7":"","Caption8":"","Caption9":"","Caption10":"","Caption11":"","Caption12":"","Caption13":"","Caption14":"","Caption15":"","Caption16":"","Caption17":"","Caption18":"","Caption19":"","Caption20":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Jumi', 'module', 'mod_jumi', '', 0, 1, 0, 0, '{"legacy":false,"name":"Jumi","type":"module","creationDate":"January 2011","author":"Edvard Ananyan","copyright":"Copyright (c) 2006 - 2010 Martin Hajek, 2011 - 2015 Edvard Ananyan. All rights reserved.","authorEmail":"info@2glux.com","authorUrl":"http:\\/\\/2glux.com","version":"3.0.1","description":"MOD_JUMI_DESC","group":""}', '{"notepad":"","@spacer":"","code_written":"","source_code_storage":"","default_absolute_path":"","moduleclass_sfx":"","cache":"1","cache_time":"900"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'System - Jumi', 'plugin', 'jumi', 'system', 0, 1, 1, 0, '{"legacy":false,"name":"System - Jumi","type":"plugin","creationDate":"January 2011","author":"Edvard Ananyan","copyright":"Copyright (c) 2006 - 2010 Martin Hajek, 2011 - 2015 Edvard Ananyan. All rights reserved.","authorEmail":"info@2glux.com","authorUrl":"http:\\/\\/2glux.com","version":"3.0.4","description":"JUMIPLUGINDESC","group":""}', '{"default_absolute_path":"","hide_code":"0","nested_replace":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'System - Jumi Router', 'plugin', 'jumirouter', 'system', 0, 1, 1, 0, '{"legacy":false,"name":"System - Jumi Router","type":"plugin","creationDate":"January 2011","author":"Edvard Ananyan","copyright":"Copyright (C) 2008 - 2011 Edvard Ananyan. All rights reserved.","authorEmail":"edo888@gmail.com","authorUrl":"http:\\/\\/edo.webmaster.am","version":"2.0.6","description":"SEF routing plugin for Jumi, which will enable direct access to jumi application with it''s alias.","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 100, 0),
(10004, 'com_jumi', 'component', 'com_jumi', '', 1, 1, 0, 0, '{"legacy":false,"name":"com_jumi","type":"component","creationDate":"January 2011","author":"Edvard Ananyan","copyright":"Copyright (c) 2008 - 2015 Edvard Ananyan. All rights reserved.","authorEmail":"info@2glux.com","authorUrl":"http:\\/\\/2glux.com\\/","version":"3.0.5","description":"This component includes custom scripts (html, php, js, css, ...) into Joomla! pages.<br \\/>Collaboration between multiple Joomla! pages and other Jumi extensions is easy.<br \\/>For Jumi downloads and guides visit <a href=\\"http:\\/\\/2glux.com\\/projects\\/jumi\\" target=\\"_blank\\">http:\\/\\/2glux.com\\/projects\\/jumi<\\/a><br \\/>For Jumi demos, tips and tricks visit <a href=\\"http:\\/\\/2glux.com\\/projects\\/jumi\\/tutorial\\" target=\\"_blank\\">http:\\/\\/2glux.com\\/projects\\/jumi\\/tutorial<\\/a>","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_finder_filters`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_filters` (
...
--
-- Структура таблицы `mylr5_finder_links`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links` (
...
--
-- Структура таблицы `mylr5_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms0` (
...
--
-- Структура таблицы `mylr5_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `mylr5_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `mylr5_finder_taxonomy`
--

INSERT INTO `mylr5_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `mylr5_finder_terms`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_terms` (
...
--
-- Структура таблицы `mylr5_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `mylr5_finder_terms_common`
--

INSERT INTO `mylr5_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `mylr5_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `mylr5_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `mylr5_finder_types`
--

CREATE TABLE IF NOT EXISTS `mylr5_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `mylr5_jumi`
--

CREATE TABLE IF NOT EXISTS `mylr5_jumi` (
...
--
-- Дамп данных таблицы `mylr5_jumi`
--

INSERT INTO `mylr5_jumi` (`id`, `title`, `alias`, `path`, `custom_script`, `access`, `checked_out`, `published`) VALUES
...
--
-- Структура таблицы `mylr5_languages`
--

CREATE TABLE IF NOT EXISTS `mylr5_languages` (
...
--
-- Дамп данных таблицы `mylr5_languages`
--

INSERT INTO `mylr5_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_menu`
--

CREATE TABLE IF NOT EXISTS `mylr5_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `mylr5_menu`
--

INSERT INTO `mylr5_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_JUMI_MENU', 'com-jumi-menu', '', 'com-jumi-menu', 'index.php?option=com_jumi', 'component', 0, 1, 1, 10004, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jumi/images/jumi.png', 0, '', 43, 44, 0, '', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_menu_types`
--

CREATE TABLE IF NOT EXISTS `mylr5_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `mylr5_menu_types`
--

INSERT INTO `mylr5_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
(2, 'side-menu', 'Sidebar Menu', 'Secondary menu');

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_messages`
--

CREATE TABLE IF NOT EXISTS `mylr5_messages` (
...
--
-- Структура таблицы `mylr5_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `mylr5_messages_cfg` (
...
--
-- Структура таблицы `mylr5_modules`
--

CREATE TABLE IF NOT EXISTS `mylr5_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `mylr5_modules`
--

INSERT INTO `mylr5_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 'Jumi', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_jumi', 1, 1, '', 0, '*'),
(88, 'Secondary menu', '', '', 1, 'left', 799, '2016-01-13 12:31:10', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"side-menu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_modules_menu`
--

CREATE TABLE IF NOT EXISTS `mylr5_modules_menu` (
...
--
-- Дамп данных таблицы `mylr5_modules_menu`
--

INSERT INTO `mylr5_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `mylr5_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `mylr5_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `mylr5_overrider`
--

CREATE TABLE IF NOT EXISTS `mylr5_overrider` (
...
--
-- Структура таблицы `mylr5_redirect_links`
--

CREATE TABLE IF NOT EXISTS `mylr5_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `mylr5_schemas`
--

CREATE TABLE IF NOT EXISTS `mylr5_schemas` (
...
--
-- Дамп данных таблицы `mylr5_schemas`
--

INSERT INTO `mylr5_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.27');

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_session`
--

CREATE TABLE IF NOT EXISTS `mylr5_session` (
...
--
-- Дамп данных таблицы `mylr5_session`
--

INSERT INTO `mylr5_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('3r6fku9g3q25gjnnpq1m66q066', 0, 1, '1452688274', '__default|a:7:{s:15:"session.counter";i:7;s:19:"session.timer.start";i:1452685642;s:18:"session.timer.last";i:1452687969;s:17:"session.timer.now";i:1452688273;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '', ''),
('b1ujhibnnctv3dudfrr0v64136', 0, 1, '1455027711', '__default|a:7:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1455027708;s:18:"session.timer.last";i:1455027708;s:17:"session.timer.now";i:1455027708;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.103 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '', ''),
('qc2sjeab2iebrngunh41t41667', 1, 0, '1452688271', '__default|a:8:{s:15:"session.counter";i:101;s:19:"session.timer.start";i:1452683305;s:18:"session.timer.last";i:1452688269;s:17:"session.timer.now";i:1452688270;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":8:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":3:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";s:12:"redirect_url";N;}s:13:"com_templates";O:8:"stdClass":2:{s:6:"styles";O:8:"stdClass":1:{s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":2:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}s:6:"source";O:8:"stdClass":2:{s:2:"id";N;s:4:"data";N;}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":2:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":2:{s:4:"menu";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}s:4:"item";O:8:"stdClass":3:{s:4:"data";N;s:4:"type";N;s:4:"link";N;}}}s:11:"com_modules";O:8:"stdClass":4:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:1:{i:0;i:88;}s:4:"data";N;}}s:9:"positions";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":4:{s:6:"search";s:0:"";s:5:"state";s:0:"";s:8:"template";s:9:"corporate";s:4:"type";s:0:"";}s:10:"limitstart";i:0;s:8:"ordercol";s:5:"value";s:9:"orderdirn";s:3:"asc";}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}s:5:"media";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:6:"layout";s:6:"thumbs";}}s:6:"editor";O:8:"stdClass":1:{s:6:"source";O:8:"stdClass":1:{s:6:"syntax";s:3:"css";}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"799";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:21:"shumakov119@gmail.com";s:8:"password";s:34:"$P$DPETjfIWBpiaCR2RdRtt11oor3oUoi/";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2016-01-13 11:00:36";s:13:"lastvisitDate";s:19:"2016-01-13 11:07:43";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"3c99d7d2a7fd88eea2df7a33547e27a6";}', 799, 'admin', '');

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_template_styles`
--

CREATE TABLE IF NOT EXISTS `mylr5_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `mylr5_updates`
--

INSERT INTO `mylr5_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(39, 3, 0, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '2.5.24.1', '', 'http://update.joomla.org/language/details/ru-RU_details.xml', ''),
(40, 3, 0, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/he-IL_details.xml', ''),
(41, 3, 0, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '2.5.28.1', '', 'http://update.joomla.org/language/details/ca-ES_details.xml', ''),
...
(44, 3, 0, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '2.5.20.1', '', 'http://update.joomla.org/language/details/zh-CN_details.xml', ''),
(45, 3, 0, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/el-GR_details.xml', ''),
(46, 3, 0, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '2.5.28.1', '', 'http://update.joomla.org/language/details/fi-FI_details.xml', ''),
(47, 3, 0, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '2.5.9.1', '', 'http://update.joomla.org/language/details/pt-BR_details.xml', ''),
(48, 3, 0, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '2.5.28.1', '', 'http://update.joomla.org/language/details/zh-TW_details.xml', ''),
...
(56, 3, 0, 0, 'Tamil India', '', 'pkg_ta-IN', 'package', '', 0, '2.5.28.2', '', 'http://update.joomla.org/language/details/ta-IN_details.xml', ''),
(57, 3, 0, 0, 'Scottish Gaelic', '', 'pkg_gd-GB', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gd-GB_details.xml', ''),
(58, 3, 0, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '2.5.28.1', '', 'http://update.joomla.org/language/details/th-TH_details.xml', ''),
...
--
-- Структура таблицы `mylr5_update_categories`
--

CREATE TABLE IF NOT EXISTS `mylr5_update_categories` (
...
--
-- Структура таблицы `mylr5_update_sites`
--

CREATE TABLE IF NOT EXISTS `mylr5_update_sites` (
...
--
-- Дамп данных таблицы `mylr5_update_sites`
--

INSERT INTO `mylr5_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1452683315),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1452683315),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1452683318);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `mylr5_update_sites_extensions` (
...
--
-- Дамп данных таблицы `mylr5_update_sites_extensions`
--

INSERT INTO `mylr5_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Структура таблицы `mylr5_usergroups`
--

CREATE TABLE IF NOT EXISTS `mylr5_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `mylr5_usergroups`
--

INSERT INTO `mylr5_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Структура таблицы `mylr5_users`
--

CREATE TABLE IF NOT EXISTS `mylr5_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `mylr5_users`
--

INSERT INTO `mylr5_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(799, 'Super User', 'admin', 'shumakov119@gmail.com', '$P$DPETjfIWBpiaCR2RdRtt11oor3oUoi/', 'deprecated', 0, 1, '2016-01-13 11:00:36', '2016-01-13 11:08:33', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_user_notes`
--

CREATE TABLE IF NOT EXISTS `mylr5_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `mylr5_user_profiles`
--

CREATE TABLE IF NOT EXISTS `mylr5_user_profiles` (
...
--
-- Структура таблицы `mylr5_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `mylr5_user_usergroup_map` (
...
--
-- Дамп данных таблицы `mylr5_user_usergroup_map`
--

INSERT INTO `mylr5_user_usergroup_map` (`user_id`, `group_id`) VALUES
(799, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `mylr5_viewlevels`
--

CREATE TABLE IF NOT EXISTS `mylr5_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `mylr5_viewlevels`
--

INSERT INTO `mylr5_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `mylr5_weblinks`
--

CREATE TABLE IF NOT EXISTS `mylr5_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
